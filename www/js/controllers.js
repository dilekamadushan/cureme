...
controllers.controller('HomeController', ['$scope', '$http', function($scope, $htpp){
...
controllers.controller('PrescriptionController', ['$scope', '$stateParams', function($scope, $stateParams){
  
  $scope.index = $stateParams.prescriptionId;

}]);

controllers.controller('ReportController', ['$scope', function($scope){
